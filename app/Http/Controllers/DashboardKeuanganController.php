...
class DashboardKeuanganController extends BaseController
{
    public function index(Request $request)
    {
        ...
        $dipa = Dipa::with('realisasi')->where('jenis', 'kegiatan')->where('tahun', $tahun)->get();
        $realisasi = RealisasiAnggaran::where('jenis', 'kegiatan')->where('tahun', $tahun)->where('bulan', $bulan)->get();
