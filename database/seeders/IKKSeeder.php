    ...
    public function run(): void
    {
        $unitGroupData = [
            [
                ...
                'unit_id' => 1, // SEKRETARIAT INSPEKTORAT JENDERAL
                'target' => '3 (Integrated)',
            ],
            [
                'id' => 2,
                ...
                'unit_id' => 2, // INSPEKTORAT WILAYAH I
                'target' => '52%',
            ],
            [
                'id' => 3,
            ...
            // Lanjutkan dengan data lainnya dengan unit_id yang sesuai
            [
                'id' => 4,
                'nomor' => 4,
            ...
            [
                ...
                'nomor' => 1,
                'name' => 'Level IACM / Kapabilitas APIP ITJEN Kemenkumham',
                'unit_id' => 3, // INSPEKTORAT WILAYAH II
                'target' => '3 (Integrated)',
            ],
            [
                'id' => 9,
            ...
            [
                ...
                'nomor' => 1,
                'name' => 'Level IACM / Kapabilitas APIP ITJEN Kemenkumham',
                'unit_id' => 4, // INSPEKTORAT WILAYAH III
                'target' => '3 (Integrated)',
            ],
            [
                'id' => 16,
            ...
            [
                ...
                'nomor' => 1,
                'name' => 'Level IACM / Kapabilitas APIP ITJEN Kemenkumham',
                'unit_id' => 5, // INSPEKTORAT WILAYAH IV
                'target' => '3 (Integrated)',
            ],
            [
                'id' => 23,
            ...
            [
                ...
                'nomor' => 1,
                'name' => 'Level IACM / Kapabilitas APIP ITJEN Kemenkumham',
                'unit_id' => 6, // INSPEKTORAT WILAYAH V
                'target' => '3 (Integrated)',
            ],
            [
                'id' => 30,
            ...
            [
                ...
                'nomor' => 1,
                'name' => 'Level IACM / Kapabilitas APIP ITJEN Kemenkumham',
                'unit_id' => 7, // INSPEKTORAT WILAYAH VI
                'target' => '3 (Integrated)',
            ],
            [
                'id' => 37,
